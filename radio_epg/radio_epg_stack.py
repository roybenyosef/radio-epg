...
class RadioEpgStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        lambda_fn = lambda_.Function(
            ...
            environment=dict(DATA_BUCKET_NAME=epg_data_s3_bucket.bucket_name, OUT_BUCKET_NAME=epg_out_s3_bucket.bucket_name)
        )

        epg_data_s3_bucket.grant_read(lambda_fn)
        epg_out_s3_bucket.grant_read_write(lambda_fn)
